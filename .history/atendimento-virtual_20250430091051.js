    ...
    function simularRespostaAtendente(mensagemUsuario) {
        ...
        setTimeout(() => {
            ...
            // Combos e promoções
                ...
                resposta = '<strong>Combos e Promoções:</strong><br>• Corte + Barba Simples: R$ 65,00 (55 min)<br>• <spCorte + Barba Completa: R$ 70,00 (60 min)<br>• PROMOÇÃO DE MARÇO: 20% OFF em qualquer serviço às quartas-feiras!<br><br>Deseja agendar algum desses combos?';
            }
