    ...
    function simularRespostaAtendente(mensagemUsuario) {
        ...
        setTimeout(() => {
            ...
            // Combos e promoções
                ...
                resposta = '<strong>Combos e Promoções:</strong><br>• <strong>Corte + Barba Simples</strong>: R$ 65,00 (55 min)<br>• <strong>Corte + Barba Completa</strong>: R$ 70,00 (60 min)<br><br><span style="color: #FF8C00; font-weight: bold;">PROMOÇÃO DE MARÇO: 20% OFF em qualquer serviço às quartas-feiras!</span><br><br>Deseja agendar algum desses combos?';
            }
            // Endereço e localização
                ...
                resposta = `<strong>Localização:</strong><br>${da
