...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function processarAgendamento(mensagem) {
        ...
        if (msgLower.includes("agendar") || msgLower.includes("marcar") || 
            msgLower.includes("horário") || msgLower.includes("reservar") ||
            msgLower.includes("quero cortar") || msgLower.includes("quero fazer") ||
            (msgLower.includes("quero") && (msgLower.includes("corte") || msgLower.includes("barba")))) {
    ...
    function simularRespostaAtendente(mensagemUsuario) {
        ...
        setTimeout(() => {
            ...
            else if (msgLower.includes('contato') || msgLower.includes('telefone') || msgLower.includes('email')) {
