...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function processarAgendamento(mensagem) {
        ...
        const palavrasAgendamento = ["agendar", "marcar", "horario", "horário", "reservar", "quero cortar", "quero fazer", 
                                   ...
                                   "disponibilidade", "tem vaga", "tem horario", "tem horário"];
    ...
    function simularRespostaAtendente(mensagemUsuario) {
        ...
        setTimeout(() => {
            ...
            // Combos e promoções
                ...
                resposta = '<strong>Combos e Promoções:</strong><br>• Corte + Barba Simples: R$ 65,00 (55 min)<br>• <span Corte + Barba Completa: R$ 70,00 (60 min)<br>• PROMOÇÃO DE MARÇO: 20% OFF em qualquer serviço às quartas-feiras!<br><br>Deseja agendar algum desses combos?';
            }
